function answerUserInput(input) {
    ...
    const knowledgeBase = [
        ...
        { question: "Số điện thoại trợ giúp nếu bị bạo lực học đường?", answer: "Tổng đài quốc gia bảo vệ trẻ em: 111" },
    ...
    // Function to find the best match from knowledge base
